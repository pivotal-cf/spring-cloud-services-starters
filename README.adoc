image:https://build.spring.io/plugins/servlet/wittified/build-status/CLOUD-SCSSTART["Build Status", link="https://build.spring.io/browse/CLOUD-SCSSTART"] image:https://circleci.com/gh/pivotal-cf/spring-cloud-services-starters.svg?style=svg["CircleCI", link="https://circleci.com/gh/pivotal-cf/spring-cloud-services-starters"]
