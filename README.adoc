...
| *4.4.x* | *2025.1.x* | *4.0.x* & *4.1.x* | *17* |
| *4.3.x* | *2025.0.x* | *3.5.x* | *17* |
| 4.2.x | 2024.0.x | 3.4.x | 17 | ⚠️ EOL
| 4.1.x | 2023.0.x | 3.2.x & 3.3.x | 17 | ⚠️ EOL
| 4.0.x | 2022.0.x | 3.0.x & 3.1.x | 17 | ⚠️ EOL
| 3.5.x | 2021.0.x | 2.7.x | 8 | ⚠️ EOL
| 3.4.x | 2021.0.x | 2.6.x | 8 | ⚠️ EOL
| 3.3.x | 2020.0.x | 2.5.x | 8 | ⚠️ EOL
|===
