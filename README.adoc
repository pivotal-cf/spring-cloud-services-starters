image:https://circleci.com/gh/pivotal-cf/spring-cloud-services-starters.svg?style=svg["CircleCI", link="https://circleci.com/gh/pivotal-cf/spring-cloud-services-starters"]
