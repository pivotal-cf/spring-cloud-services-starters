= Spring Cloud Services Starters image:https://build.spring.io/plugins/servlet/wittified/build-status/CLOUD-SCSSTART["Build Status", link="https://build.spring.io/browse/CLOUD-SCSSTART"]
